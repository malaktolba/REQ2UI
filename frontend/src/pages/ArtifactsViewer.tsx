...
// The generated page already carries its own brand colour (a `brand-*` Tailwind
// scale baked into its <head> at generation); colour changes go through AI
// refinement ("AI UI tweaks"), not a live client-side recolour.
